...
from Freaky.utilities.config import MUSIC_BOT_NAME, YOUTUBE_IMG_URL
...
async def gen_thumb(videoid):
    ...
    try:
        ...
        image2 = Image.open(f"Freaky/resource/{images}.png")
        ...
        font = ImageFont.truetype("Freaky/resource/font.otf", 32)
        draw.text((190, 555), f"ᴛɪᴛʟᴇ: {title[:50]} ...", (255, 255, 255), font=font)
        draw.text((190, 595), f"ᴅᴜʀᴀᴛɪᴏɴ: {duration}", (255, 255, 255), font=font)
        draw.text((190, 635), f"ᴠɪᴇᴡs: {views}", (255, 255, 255), font=font)
        draw.text((190, 675), f"ᴘᴏᴡᴇʀᴇᴅ ʙʏ: ᴄʜᴧᴍᴘᴜ ꭙᴅ (@TheShivanshu)", (255, 255, 255), font=font)
        try:
