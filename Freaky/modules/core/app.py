    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                ...
                await self.one.join_chat("Freaky_Support")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                ...
                await self.two.join_chat("Freaky_Support")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                ...
                await self.three.join_chat("Freaky_Support")
            except:
                pass
            assistants.append(3)
            try:
                ...
                sys.exit()
            LOGGER(__name__).info(
                f"🎄 ᴀssɪsᴛᴀɴᴛ 3 sᴛᴀʀᴛᴇᴅ 🌿 ᴀs {self.one.name} ✨..."
            )
        if config.STRING4:
            ...
            try:
                ...
                await self.four.join_chat("Freaky_Support")
            except:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                ...
                await self.five.join_chat("Freaky_Support")
            except:
                pass
            assistants.append(5)
            try:
