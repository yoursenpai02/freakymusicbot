...
from Freaky.utilities.config import (BANNED_USERS, CLEANMODE_DELETE_MINS,
                    MUSIC_BOT_NAME, OWNER_ID)
from Freaky.utilities.strings import get_command
from Freaky import bot
from Freaky.modules.database import (add_nonadmin_chat,
