...
from Freaky.utilities.strings import get_command, get_string, languages_present
from Freaky import bot
from Freaky.modules.database import get_lang, set_lang
from Freaky.modules.decorators import (ActualAdminCB, language,
                                         languageCB)
